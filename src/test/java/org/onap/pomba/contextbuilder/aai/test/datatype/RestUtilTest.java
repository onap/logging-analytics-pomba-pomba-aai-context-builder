...
public class RestUtilTest {
    ...
    public void testObtainResouceLinkBasedOnServiceInstanceFromAai() throws Exception {
        ...
        String resourceLinkUlr = RestUtil.obtainResouceLinkBasedOnServiceInstanceFromAAI(aaiClient,
                                                                                         aaiBaseUrl,
    ...
    public void testObtainResouceLinkBasedOnServiceInstanceFromAaiNullResourceLink() throws Exception {
        ...
        try {
            RestUtil.obtainResouceLinkBasedOnServiceInstanceFromAAI(aaiClient,
                                                                    aaiBaseUrl,
                                                                    aaiPathToSearchNodeQuery,
                                                                    serviceInstanceId,
                                                                    requestId,
    ...
    public void testretrieveAaiModelDataFromAaiVserverPserver() throws Exception {
        ...
        assertEquals(vmList.get(0).getUuid(), "b494cd6e-b9f3-45e0-afe7-e1d1a5f5d74a");
        assertEquals(vmList.get(0).getPServer().getName(), "mtn96compute.cci.att.com");
    }
    ...
    public void testretrieveAaiModelDataFromAaiPinterfaceLinterfaceWithPnf() throws Exception {
        ...
        addResponse("/aai/v13/network/pnfs/pnf/amdocsPnfName"
                  + DEPTH,
                    "junit/pnfInput_w_pInterface_LInterface.json",
                    aaiEnricherRule);
    ...
    public void testretrieveAaiModelDataFromAaiPinterfaceLinterfaceWithPserver() throws Exception {
        ...
        addResponse("/aai/v13/cloud-infrastructure/pservers/pserver/mtn96compute.cci.att.com"
                  + DEPTH,
                    "junit/pserverInput_with_pInterface_LInterface.json",
                    aaiEnricherRule);
    ...
    public void testretrieveAaiModelDataFromAaiL3NetworkInServiceLevel() throws Exception {
        ...
        addResponse("/aai/v13/business/customers/customer/DemoCust_651800ed-2a3c-45f5-b920-85c1ed155fc2"
                  + "/service-subscriptions/service-subscription/vFW/service-instances/service-instance/"
                  + "adc3cc2a-c73e-414f-8ddb-367de81300cb",
                    "junit/aai-service-instance_set3.json",
                    aaiEnricherRule);

        // 3. simulate the rsp of l3-network
        // note: match to network-id to the path of "l3network" in (2:  aai-service-instance_set3)
        addResponse("/aai/v13/network/l3-networks/l3-network/01e8d84a-l3-network-1"
                   + DEPTH,
                    "junit/l3-network-1.json",
                    aaiEnricherRule);
        addResponse("/aai/v13/network/l3-networks/l3-network/01e8d84a-l3-network-2"
                   + DEPTH,
                    "junit/l3-network-2.json",
                    aaiEnricherRule);
    ...
    public void testretrieveAaiModelDataFromAaiL3NetworkInVnfLevel() throws Exception {
        ...
        addResponse("/aai/v13/network/generic-vnfs/generic-vnf/8a9ddb25-2e79-449c-a40d-5011bac0da39"
                    + DEPTH,
                    "junit/genericVnfInput_set3.json",
                    aaiEnricherRule);
        ...
        when(mockHttpServletRequest.getRemoteAddr()).thenReturn("testretrieveAaiModelDataFromAaiL3NetworkInVnfLevel");
    ...
    public void testretrieveAaiModelDataFromAaiL3NetworkInvModuleLevel() throws Exception {
        ...
        addResponse("/aai/v13/network/generic-vnfs/generic-vnf/8a9ddb25-2e79-449c-a40d-5011bac0da39"
                  + DEPTH,
                    "junit/genericVnfInput_set4.json",
                    aaiEnricherRule);
